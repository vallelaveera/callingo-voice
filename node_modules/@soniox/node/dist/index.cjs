...
//#endregion
//#region ../core/src/realtime/async-queue.ts
/**
...
//#endregion
//#region ../core/src/realtime/emitter.ts
/**
...
//#endregion
//#region ../core/src/realtime/errors.ts
/**
...
function segmentRealtimeTokens(tokens, options = {}) {
	return segmentTokens(options.final_only ? tokens.filter((token) => token.is_final) : tokens, options, buildSegment$1);
}
...
//#endregion
//#region ../core/src/realtime/segment-buffer.ts
...
//#endregion
//#region ../core/src/realtime/utterance-buffer.ts
/**
...
var TranscriptionListResult = class {
	...
	*/
	next_page_cursor;
	constructor(initialResponse, _http, _options, _signal) {
		this._http = _http;
	...
	*/
	async transcribe(options) {
		...
		try {
			...
			if (options.wait) {
				const waitOptions = { ...options.wait_options };
				...
				} else if (combinedSignal) waitOptions.signal = combinedSignal;
