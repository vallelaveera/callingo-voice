...
//#endregion
//#region ../core/src/types/errors.d.ts
/**
...
//#endregion
//#region ../core/src/types/realtime.d.ts
/**
...
type SttSessionOptions = {
  ...
  /**
   * Interval for sending keepalive messages while paused (milliseconds).
   * @default 5000
   */
 ...
 */
type AudioData$1 = Uint8Array | ArrayBuffer;
/**
...
declare class RealtimeSttSession implements AsyncIterable<RealtimeEvent> {
   ...
   */
  sendAudio(data: AudioData$1): void;
  /**
   ...
   * @throws {@link StateError} If not connected
   */
  sendStream(stream: AsyncIterable<AudioData$1>, options?: SendStreamOptions): Promise<void>;
  /**
...
//#endregion
//#region ../core/src/realtime/segment-buffer.d.ts
/**
...
//#endregion
//#region ../core/src/realtime/utterance-buffer.d.ts
/**
...
declare class SonioxFilesAPI {
   ...
   * ```
   */
  delete_all(options?: DeleteAllFilesOptions): Promise<void>;
}
//#endregion
...
declare class TranscriptionListResult implements AsyncIterable<SonioxTranscription> {
   ...
   */
  readonly next_page_cursor: string | null;
  constructor(initialResponse: ListTranscriptionsResponse<SonioxTranscriptionData>, _http: HttpClient, _options: ListTranscriptionsOptions, _signal?: AbortSignal | undefined);
  /**
   * Returns the raw data for this list result
   */
...
declare class SonioxSttApi {
   ...
   * ```
   */
  get(id: TranscriptionIdentifier, signal?: AbortSignal): Promise<SonioxTranscription | null>;
  /**
   ...
   * ```
   */
  delete(id: TranscriptionIdentifier, signal?: AbortSignal): Promise<void>;
  /**
   ...
   * ```
   */
  delete_all(options?: DeleteAllTranscriptionsOptions): Promise<void>;
  /**
